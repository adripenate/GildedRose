...
namespace GildedRoseCSharp.Test {
    public class GlidedRoseTest {
        ...
        [Test]
        public void should_degrade_conjured_item_quality_by_four()
        {
            List<Item> Items = new List<Item>() { new Item { Name = "Conjured", SellIn = 0, Quality = 20 } };
            var app = new GildedRose.GildedRose(Items);
            app.UpdateQuality();

            List<Item> expectedOutput = new List<Item>() { new Item { Name = "Conjured", SellIn = -1, Quality = 16 } };
